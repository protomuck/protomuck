...
MFNDAT mfun_list[] =
{
    ...
    {"INDEX",     mfn_index,     1, 1, 1,  1, 2},
    {"INDEX!",    mfn_indexbang, 1, 1, 1,  1, 2},
    ...
    {"MAX",       mfn_max,       1, 0, 1,  2, 9},
    {"MATCH",     mfn_match,     1, 0, 1,  1,-1},
    {"MIDSTR",    mfn_midstr,    1, 0, 0,  2, 3},
    {"MIN",       mfn_min,       1, 0, 1,  2, 9},
    ...
    {"OR",        mfn_or,        0, 0, 1,  2, 9},
    {"OANSI",     mfn_oansi,     1, 0, 0,  1, 3},
    {"OHTML",     mfn_ohtml,     1, 0, 0,  1, 3},
    ...
    {"SHOWLIST",  mfn_showlist,  1, 0, 1,  1, 2},
    {"SMATCH",    mfn_smatch,    1, 0, 0,  2, 2},
    {"STIMESTR",  mfn_stimestr,  1, 0, 1,  1, 1},
    {"STOPMIDI",  mfn_stopmidi,  0, 0, 0,  0, 0},
