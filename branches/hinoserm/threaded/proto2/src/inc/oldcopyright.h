...
Legacy code copyright notice:
Copyright (c) 1989, 1990 by David Applegate, James Aspnes, Timothy Freeman,
			    Bennet Yee, and Na Choon Piaw (lachesis).

NeonMuck Specific Copyright notice:
Copyright (c) 1996 by Jeremy Blackman, Andrew Nelson, and Joseph Traub

ProtoMuck Specific Copyright notice:
Copyright (c) 2000 by Chris Brine, Richard Taylor

Copyright text for MUCK:
...
Copyright notice for the Pueblo multimedia protocol:
Pueblo is (C) 1995-96 by Chaco Communications
*/
