...
#define IN_CATCH          9
#define IN_CATCH_DETAILED 10

#define BASE_MIN 1
#define BASE_MAX (10 + PRIMS_CONNECTS_CNT + PRIMS_DB_CNT + PRIMS_MATH_CNT + \
    ...
    PRIMS_MYSQL_CNT + PRIMS_MUFEDIT_CNT + PRIMS_REGEX_CNT + PRIMS_HTTP_CNT +\
    PRIMS_JSON_CNT) /* hinoserm */
